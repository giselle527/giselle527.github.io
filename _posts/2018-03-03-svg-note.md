...
* aria-hidden：图标的可访问性，见[2.1.3](#anchor2.1.3)。
* role：该属性定义了对象的通用类型。
* viewBox: 涉及到viewport/preserveAspectRatio等知识，移步[理解SVG viewport,viewBox,preserveAspectRatio缩放]{http://www.zhangxinxu.com/wordpress/2014/08/svg-viewport-viewbox-preserveaspectratio/}。
* path，路径，见[2.1.2](#anchor2.1.2)。

#### <h4 id="anchor2.1.2">2.1.2 路径</h4>
...
#### <h4 id="anchor2.1.3">2.1.3 aria-hidden属性</h4>
